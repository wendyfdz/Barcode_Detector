...
#Get Line Segments
barcode=io.imread('05102009082.jpg')
...
img = cv2.line(barcode,(Segments[max_toDisplay,0,0],Segments[max_toDisplay,0,1]),(Segments[max_toDisplay,0,2], Segments[max_toDisplay,0,3]),(255,0,0),3)
io.imshow(img)
io.show()